...
const StepsSection: React.FC = () => {
  return (
    <section id="steps" className="py-20 sm:py-28 bg-white">
        ...
        <div className="grid sm:grid-cols-3 gap-8">
          {steps.map((s, i) => {
            ...
            return (
              <div
                key={i}
                className="flex flex-col sm:flex-row sm:items-start gap-5 p-8 rounded-2xl bg-white border border-slate-100 shadow-sm hover:border-primary/20 transition-colors"
              >
